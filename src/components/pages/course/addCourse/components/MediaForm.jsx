...
//     // Use a different approach to update YouTube URL
//     if (handleFileChange) {
//       handleFileChange({
//         target: {
//           name: 'youtube_url',
//           value: url,
//           type: 'text', // Add type to avoid file access
...
//     // Use a different approach when clearing values
//     if (source === 'youtube') {
//       // Clear the upload video value
//       if (handleFileChange) {
//         handleFileChange({
//           target: {
//             name: 'course_intro_video',
